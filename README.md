...
Пользователь загружает `ratings.csv` (опционально `diary.csv`) и получает дашборд в стиле «Spotify Wrapped», но для кино: метрики, ранжирования, графики, теги, десятилетия и персональные инсайты.
