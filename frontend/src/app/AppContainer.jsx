...
import { clearCache, getLastReport } from '../utils/indexedDbCache.js'
import { MOCK_OPTIONS, USE_MOCKS } from '../mocks/index.js'
import { isMobileClient } from '../utils/app/mobileRules.js'
import AppView from './AppView.jsx'
import { useResumeState } from '../features/resume/useResumeState.js'
import { useCsvAnalysisFlow } from '../features/upload/useCsvAnalysisFlow.js'
import { useDemoLoader } from '../features/demo/useDemoLoader.js'
...
function AppContainer() {
  ...
  useEffect(() => {
    ...
    setSelectedYears(years.length === 1 ? [years[0]] : [])
  }, [analysis])
  ...
  const { demoMockId, setDemoMockId, handleLoadDemo, handleLoadDemoCSV, handleLoadDemoReport } = useDemoLoader({
    ...
    setLastUploadedFileName,
    setLastReportAvailable,
    runAnalysis: (file, simplified) => runAnalysis(file, simplified, isMobileClient()),
  })
