 ...
 */
export const GENRE_GLOBAL_FREQUENCY: Record<string, number> = {
 ...
 * 
 * @param genreName - Название жанра на английском (как в TMDb)
 * @returns Глобальная частота жанра в процентах (0-100), или null если жанр не найден
 */
export function getGenreGlobalFrequency(genreName: string | null | undefined): number | null {
 ...
 * 
 * @returns Map: название жанра → глобальная частота (%)
 */
export function createGenreGlobalFrequencyMap(): Map<string, number> {
