...
const genreIcons: Record<string, GenreIcon> = {
  Action: { 
 ...
 * @param genreName - название жанра (обычно на английском из TMDB)
 * @returns объект с URL иконки, fallback эмодзи и цветом
 */
export function getGenreIcon(genreName: string | null | undefined): GenreIcon {
